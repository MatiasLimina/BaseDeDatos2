-- =====================================================================
-- Proyecto Integrador: Food Store (TP3 — Punto 4.2)
-- Archivo: views.sql
-- Motor: PostgreSQL
-- Descripción: Vistas de reporte del sistema Food Store
-- Spec:  Proyecto_Integrador/specs/spec_punto_4.2/requirements.md
-- =====================================================================
...
SELECT
  ...
  -- Excluidos deliberadamente: c.email, c.telefono, c.created_at
  -- Motivo: datos de contacto personal; el acceso a la vista no debe
  -- implicar acceso a datos sensibles de la tabla base.
FROM pedido p
